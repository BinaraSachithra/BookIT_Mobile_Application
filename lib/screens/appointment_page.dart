...
class _AppointmentPageState extends State<AppointmentPage> {
  ...
  List<dynamic> schedules = [
    {
      "doctor_name": "Dr. C. Abeysinghe",
      "doctor_profile": "assets/doctor_3.jpg",
      "category": "Dental",
      "status": FilterStatus.upcoming,
    },
    {
      "doctor_name": "Dr. Saduni Silva",
      "doctor_profile": "assets/doctor_4.jpg",
      "category": "Cardilology",
      "status": FilterStatus.complete,
    },
    {
      "doctor_name": "Dr. Nimal Jayawardane",
      "doctor_profile": "assets/doctor_8.jpg",
      "category": "General",
      "status": FilterStatus.complete,
    },
    {
      "doctor_name": "Dr. Nilmini Hewawitharana",
      "doctor_profile": "assets/doctor_9.jpg",
...
class SceduleCard extends StatelessWidget {
  const SceduleCard({Key? key}) : super(key: key);
